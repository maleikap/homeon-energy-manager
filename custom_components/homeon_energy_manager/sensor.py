...
SENSORS = [
    ...
    ("inverter_entity_grid_charging", "Sterowanie encja ładowania z sieci", None, "mdi:toggle-switch"),
    ("inverter_entity_export_surplus", "Sterowanie encja eksportu nadwyżki", None, "mdi:toggle-switch"),
    ("inverter_entity_export_surplus_power", "Sterowanie encja mocy eksportu", None, "mdi:numeric"),
    ("inverter_entity_max_charge_current", "Sterowanie encja prądu ładowania", None, "mdi:numeric"),
    ("inverter_entity_max_discharge_current", "Sterowanie encja prądu rozładowania", None, "mdi:numeric"),
]
