...
NUMBERS = [
    ...
    ("economic_good_sell_price", "Cena dobrej sprzedaży", -5, 5, 0.01, "PLN/kWh", "mdi:cash-plus", 0.55),
    ("economic_cheap_charge_price", "Cena taniego ładowania", -5, 5, 0.01, "PLN/kWh", "mdi:battery-plus", 0.30),
    ("economic_negative_buy_price", "Próg ceny ujemnej zakupu", -5, 5, 0.01, "PLN/kWh", "mdi:cash-minus", 0.00),
    ("economic_negative_sell_price", "Próg ceny ujemnej sprzedaży", -5, 5, 0.01, "PLN/kWh", "mdi:cash-remove", 0.00),
    ("economic_expensive_buy_price", "Cena drogiego zakupu", -5, 5, 0.01, "PLN/kWh", "mdi:cash-alert", 0.55),
    ("economic_min_sell_price_prepare", "Minimalna cena zwalniania magazynu", -5, 5, 0.01, "PLN/kWh", "mdi:battery-arrow-down", 0.05),
    ("economic_min_energy_to_free_kwh", "Minimalna energia do zwolnienia", 0, 100, 0.1, "kWh", "mdi:battery-minus", 0.5),
    ("economic_negative_prepare_hours", "Maksymalny czas przygotowania ceny ujemnej", 0, 24, 0.5, "h", "mdi:clock-fast", 6),
    ...
    ("battery_charge_efficiency_percent", "Sprawność ładowania baterii", 50, 100, 0.5, "%", "mdi:battery-plus", 94),
    ("battery_discharge_efficiency_percent", "Sprawność rozładowania baterii", 50, 100, 0.5, "%", "mdi:battery-minus", 94),
    ("battery_nominal_voltage_v", "Napięcie nominalne baterii", 12, 1000, 0.1, "V", "mdi:sine-wave", 51.2),
