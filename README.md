...
The `test/0.2.44-beta.1` branch currently contains the 0.2.44 beta series. Stable installations should remain on the latest stable HACS release until testing is complete.
